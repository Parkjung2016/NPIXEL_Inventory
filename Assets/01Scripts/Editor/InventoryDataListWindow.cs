...
public class InventoryDataListWindow : EditorWindow
{
    ...
    {
        _attributeListSO = InventoryEditorUtility.LoadAsset<ItemAttributeListSO>("03SO/ItemAttributeListSO.asset");
        _targetSO = InventoryEditorUtility.LoadAsset<InventoryDataListSO>("03SO/Inventory/InventoryDataListSO.asset");
    ...
    private void DrawToolbar()
    {
        ...
        if (GUILayout.Button("Add Item"))
            InventoryEditorUtility.AddNewItem(_targetSO, _itemTypes[_selectedTypeIndex]);

        GUI.backgroundColor = Color.red;
        if (_selectedIndex >= 0 && GUILayout.Button("Delete Selected"))
            InventoryEditorUtility.DeleteItem(_targetSO, _selectedIndex);
