...
{
    [SerializeField] private SerializableDictionary<ItemType, InventorySO> _inventorySODictionary =
        new SerializableDictionary<ItemType, InventorySO>();

    private Dictionary<ItemType, InventorySO> _inventorySOIstanceDictionary = new Dictionary<ItemType, InventorySO>();

    public InventorySO this[ItemType itemType] =>
    ...
    public bool TryGetItemType(InventorySO inventorySO, out ItemType itemType)
    {
    ...
    {
        Dictionary<ItemType, List<ItemDataBase>> itemDataDictionary = new();
